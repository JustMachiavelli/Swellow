...
namespace Swellow.API.Sql.Init
{
    public class DbInitializer
    {
        public static void Initialize(SwellowDbContext context)
        {
            ...
            workCasts2.AddRange(GetOneTypeWorkCasts(context, new string[] { "托德·菲利普斯" }, CastType.Director));
            workCasts2.AddRange(GetOneTypeWorkCasts(context, new string[] { "华金·菲尼克斯", "罗伯特·德尼罗", "马克·马龙", "莎姬·贝兹", "谢伊·惠格姆" }, CastType.Actor));
            movie2.WorkCasts = workCasts2;

            List<WorkCompany> workCompanies2 = new();
            workCompanies2.AddRange(GetOneTypeWorkCompanys(context, new string[] { "华纳兄弟公司", "DC Comics", "美国威秀影片公司", "Bron Studios", "DC Comics", "22 & Indiana Pictures" }, CompanyType.Producer));
            workCompanies2.AddRange(GetOneTypeWorkCompanys(context, new string[] { "华纳兄弟公司", "Karo Premiere", "Tanweer Alliances", "Bron Studios", "NOS Audiovisuais", }, CompanyType.Producer));
            ...
            workCasts3.AddRange(GetOneTypeWorkCasts(context, new string[] { "刘伟强", "麦兆辉" }, CastType.Director));
            workCasts3.AddRange(GetOneTypeWorkCasts(context, new string[] { "周杰伦", "陈冠希", "铃木杏", "余文乐", "钟镇涛" }, CastType.Actor));
            movie3.WorkCasts = workCasts3;

            List<WorkCompany> workCompanies3 = new();
            workCompanies3.AddRange(GetOneTypeWorkCompanys(context, new string[] { "CJ Entertainment", "Barunson E&A", }, CompanyType.Producer));
            ...
            workCasts5.AddRange(GetOneTypeWorkCasts(context, new string[] { "山本泰一郎" }, CastType.Director));
            workCasts5.AddRange(GetOneTypeWorkCasts(context, new string[] { "高山南", "山崎和佳奈", "神谷明", "小山力也" }, CastType.Actor));
            mix5.WorkCasts = workCasts5;
            mix5.WorkCompanys = GetAllWorkCompanys(
                context, 
                new string[] { "TMS Entertainment", }, 
            ...
            context.Works.AddRange(movie1, movie2, movie3);
            context.SaveChanges();
        }
        ...
        public static List<Movie> GetMovies(SwellowDbContext context)
        {
            Tv movie = new()
            {
                Type = TvType.SingleMovie,
            ...
            workCasts4.AddRange(GetOneTypeWorkCasts(context, new string[] { "永冈智佳" }, CastType.Director));
            workCasts4.AddRange(GetOneTypeWorkCasts(context, new string[] { "高山南", "山口胜平", "山崎和佳奈", "小山力也", "绪方贤一" }, CastType.Actor));
            movie.WorkCasts = workCasts4;

            List<WorkCompany> workCompanies4 = new();
            workCompanies4.AddRange(GetOneTypeWorkCompanys(context, new string[] { "东宝株式会社", "小学馆", }, CompanyType.Publisher));
            movie.WorkCompanys = workCompanies4;

            movie.WorkGenres = GetWorkGenres(context, new string[] { "动画 ", "悬疑", });
            movie.WorkTags = GetWorkTags(context, new string[] { "飞机", "度假", "友情" });
