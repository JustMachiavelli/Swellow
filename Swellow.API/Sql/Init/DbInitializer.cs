...
namespace Swellow.API.Sql.Init
{
    public class DbInitializer
    {
        public static void Initialize(SwellowDbContext context)
        {
            ...
            workCompanies3.AddRange(GetWorkCompanys(context, new string[] { "CJ Entertainment", }, CompanyType.Publisher));
            ...
            workCompanies4.AddRange(GetWorkCompanys(context, new string[] { "名侦探柯南制作委员会", }, CompanyType.Producer));
            ...
            List<Library> Librarys = new List<Library>
            {
                new Library
                {
                    ...
                    Folders = new List<VideoFolder>
                    {
                        ...
                        new VideoFolder{ Path = "/TestMovies/科幻3", },
                    }
                },
                new Library
                {
